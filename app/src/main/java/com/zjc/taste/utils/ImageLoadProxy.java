...
public class ImageLoadProxy {
    ...
    public static void initImageLoader(Context context) {
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(context)
                ...
                .diskCacheSize(ImageLoadProxy.MAX_DISK_CACHE)
                .memoryCacheSize(ImageLoadProxy.MAX_MEMORY_CACHE)
                .memoryCache(new LruMemoryCache(ImageLoadProxy.MAX_MEMORY_CACHE))
                .diskCache(new UnlimitedDiscCache(new File(Constants.DIR_IMAGE)))
                .build();
