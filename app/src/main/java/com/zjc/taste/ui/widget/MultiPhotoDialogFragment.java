package com.zjc.taste.ui.widget;
...
public class MultiPhotoDialogFragment extends DialogFragment {
    ...
    private void initView() {
        ...
        tvAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent("com.mobo.curefuturedoctor.action.CHOSE_PHOTOS");
                //指定图片选择数
    ...
    private void sendCameraUriToView(String uri) {
        try {
            EventBus.getDefault().post(new ActionCameraEvent(UtilUri.getLocalUri(uri), action));
            getDialog().dismiss();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void sendMultiPhotoUrisToView(List<String> uris) {
        try {
            EventBus.getDefault().post(new ActionMultiPhotoEvent(UtilUri.getLocalUri(uris), action));
            getDialog().dismiss();
        } catch (Exception e) {
            e.printStackTrace();
        }
