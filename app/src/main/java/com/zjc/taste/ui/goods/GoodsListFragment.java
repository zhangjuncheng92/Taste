...
/**
 * @author Z
 * @Filename GoodsListFragment.java
 * @Date 2017.08.25
 * @description 商品列表
 */
public class GoodsListFragment extends ZBaseFragment implements ZBaseRecyclerViewAdapter.OnItemClickListener, ZBaseRecyclerViewAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
     ...
     */
    public static GoodsListFragment newInstance(int bean) {
